...
function displayCheckoutHistory() {
    ...
    foreach ($records as $record) {
        ...
        echo  "<strong>Name:</strong> " . $record['firstName'] . "  " . $record['lastName'] . " <strong>Email:</strong>" . $record['email'] . " <strong>Phone Number:</strong>" . $record['phone'] . " <strong>Role:</strong>" . $record['role'] . "<br />";
